...
def printUsageAndExit (  ):
        print ("Usage: wsadmin -lang jython -f twas_cell_stop_cluster.py cluster <cluster1>")
        print ("or:")
        print ("Usage: wsadmin -lang jython -f twas_cell_stop_cluster.py cluster <cluster1> <cluster2>")
        sys.exit()
#endDef 
