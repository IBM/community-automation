...
The role expects to be supplied:
 ...
 - fyre_addMode (optional: defaults to true)
...
4) One of the following will happen
   a) If fyre_addMode is true, An ansible host will be added to represent the inf node within the cluster. This node will be part of the supplied group
   b) If fyre_addMode is false, The current ansible host will be update with information about the cluster.
